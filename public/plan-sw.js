...
const CACHE_NAME = 'pepemegia-plan-cache-v1';
...
const urlsToCache = [
  ...
  '/storage/icons/plan/icon-72x72.png',
  '/storage/icons/plan/icon-96x96.png',
  '/storage/icons/plan/icon-128x128.png',
  '/storage/icons/plan/icon-144x144.png',
  '/storage/icons/plan/icon-152x152.png',
  '/storage/icons/plan/icon-192x192.png',
  '/storage/icons/plan/icon-384x384.png',
  '/storage/icons/plan/icon-512x512.png'
];
